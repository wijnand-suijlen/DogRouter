...
- Each cycling leg between stops shows a mini-map of the route; tap it to
  open a full-screen map you can zoom and pan.
...
- When the stop is reached by cycling from the previous one, a mini-map
  ...
  tap it to open a full-screen map you can zoom and pan.
